...
public class RTG : EditorWindow {
	...
	static void Init () {
        ...
        RTG window = (RTG)EditorWindow.GetWindow (typeof (RTG),false, "RTG 1.3.8", true);
		window.Show();
    ...
    void OnGUI () {
        ...
        {
            trackGenerator.GetComponent<Track_Generator>().ChangeBackGround();
        }
        ...
        if (GUILayout.Button("Upgrade to 'RTG ULTIMATE'"))
        {
